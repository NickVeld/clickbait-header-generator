$(document).ready(function(){
	var pwords = 
		...
		story:{
			...
			"personI": ["Бабурин С.Н.", "Грудинин П.Н.", "Жириновский В.В.", "Путин В.В.", "Собчак К.А.", "Сурайкин М.А.", "Титов Б.Ю.", "Явлинский Г.А." ],
			...
			"youwontbelieve": ["Этот факт #makeyou#", "Вы не поверите, что случилось потом", 
					"Больше Вы не сможете так же относится к э1тому", "Вы будете шокированы ответом"],
